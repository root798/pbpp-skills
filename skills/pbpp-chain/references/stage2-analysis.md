...
Production use of T-2.3 requires, before any real prediction: an approved
model and its documented domain of applicability, a stated confidence
threshold below which the output is UNKNOWN, and the privacy rules above
applied to individual-level records. Without these, this chain is a
